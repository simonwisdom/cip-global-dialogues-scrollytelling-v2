...
export const ScatterChart = ({ step }: ScatterChartProps) => {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [currentData, setCurrentData] = useState<DataPoint[]>(step === 0 ? [] : baseData);
  ...
  return (
    <div className={s["chart-container"]}>
      ...
      <p className={s["chart-description"]}>
        Correlation between depth of inquiry and perceived consciousness over time
      </p>
    </div>
  );
};